...
generateSchema.withArtifacts = (config, typeFilePath) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const typegenConfig = resolveTypegenConfig(finalConfig)
    assertNoMissingTypes(schema, missingTypes)
    const { schemaTypes, tsTypes } = yield new TypegenMetadata(typegenConfig).generateArtifactContents(
      schema,
      typeFilePath
    )
